...
$res=$Account->registerSender('MediaSend','ua');
...
$res=$Addressbook->addAddressBook('Test');
...
$res=$Addressbook->addPhoneToAddressBook($addrbook_id, '79381204388', 'Шелестенко;Николай;');
if (isset($res["result"]["error"])) {
...
$res = $Stat->checkCampaignPrice("TestSend", "Тестируем отправку смс сообщения через ePochta SMS", $addrbook_id);
if (isset($res["result"]["error"])) {
